...
<div style="width: 50%; margin: 0 auto; background-color: #eeeeee;height: 250px;margin-top: 50px">
	<div class="col-lg-12 col-md-12 col-sm-12" style="padding-top:50px;font-size:20px;width:100%;text-align: center;margin-bottom: 0px;">
		<span>管理员编号：</span><span style="margin-top: 20px" id="adminId">${adminInfo.adminId}</span><br>
		<span>管理员名称：</span><span style="margin-top: 20px">${adminInfo.adminName}</span><br>
		<span>管理员原密码：</span><span style="margin-top: 20px" id="oldPwd">${adminInfo.adminPwd}</span><br>
